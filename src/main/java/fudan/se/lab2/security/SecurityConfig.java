...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .antMatchers("/welcome","/register","/login","/contact","/personalInformation","/contactInformation","/openMeeting","/audit").permitAll()


                .antMatchers("/userContactState","/receivedInvitation","/searchMeeting","/personal","/upload","//meetingDetail","/userEssayState").permitAll()

                .antMatchers("/passContact","/refuseContact","/searchUser","/admin","/recommand","/sendInvitation","/PCmember","/refuseInvitation","/judgeRoleInMeeting").permitAll()

                .antMatchers("/getMeetingTags","/getTagsList","/startReview","/releaseResult","/sendCommentInformation","/getHistoryUpload","/passEssay","/refuseEssay","/essaysData").permitAll()

                .antMatchers("/releaseSecondResult","/endRebuttal").permitAll()
